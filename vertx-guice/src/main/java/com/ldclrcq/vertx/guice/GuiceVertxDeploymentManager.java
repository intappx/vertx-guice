...
public class GuiceVertxDeploymentManager {
     ...
     */
    public void deployVerticle(final Class<? extends Verticle> verticleClazz) {
     ...
     */
    public void deployVerticle(final Class<? extends Verticle> verticleClazz, final DeploymentOptions options) {
        Preconditions.checkNotNull(verticleClazz);
     ...
     */
    public void deployVerticle(final Class<? extends Verticle> verticleClazz, Handler<AsyncResult<String>> completionHandler) {
        Preconditions.checkNotNull(verticleClazz);
     ...
     * @param completionHandler a handler which will be notified when the deployment is complete.
     */
    public void deployVerticle(final Class<? extends Verticle> verticleClazz, final DeploymentOptions options, Handler<AsyncResult<String>> completionHandler) {
        Preconditions.checkNotNull(verticleClazz);
        Preconditions.checkNotNull(options);
        Preconditions.checkNotNull(completionHandler);
     ...
     * {@link GuiceVerticleFactory} for verticle creation.
     */
    private static String getFullVerticleName(final Class<? extends Verticle> verticleClazz) {
